                        ...
                        <div className="row">
                            <div className="col">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-3">
                                        <div className="fs-2 text-warning"><FaPhone /></div>
                                    </div>
                                   
                                   
                                    <div className="col-9">
                                        Tư vấn hỗ trợ<br /> 
                                        <strong className="text-warning">0707.5483.32</strong>
                                    </div>
                                </div>
                            </div>
                            <div className="col">
                                <div className="row">
                                    <div className="col-3">
                                        <div className="fs-2 text-warning"><FaUserTie/></div>

                                    </div>
                                    <div className="col-9">
                                        Xin chào<br />
                                       <Link style={{textDecorationLine:"none"}} to="/Login"> <strong className="text-warning">Đăng nhập</strong></Link>
                                    </div>
                                </div>
                            </div>
                        </div>
